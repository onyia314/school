        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-8">
                ...
                @if( session()->exists('classAdded') )
                        <div class="alert alert-success text-center">class created.. A classroom does not exist if you don't make SECTION.. click on the <a href="{{url( 'settings/showclass/' .session('classAdded') )}}">link</a> to add section</div>
                @endif
